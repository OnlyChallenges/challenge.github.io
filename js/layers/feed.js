addLayer("F", {
    ...
    upgrades: {
        ...
        22: {
            title: "Imaginary Red Cooldown<br>[ <text style='color:darkred'>I-8</text> ]",
            description: "<text style='color:#5b85b3'>Chemicals</text> boost <text style='color:pink'>E-3</text>",
            cost() {return new Decimal(7)},
            effect() {
                let effect1 = (player.P.points.max(1).add(1).pow(0.063)).max(1).min(20);
