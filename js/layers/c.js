addLayer("c", {
    ...
    doReset(resettingLayer) {
        ...
        if (hasMilestone ('F', 14) && resettingLayer=="F") player.c.upgrades.push("51", "52", "53", "54", "55")
        if (hasMilestone ('F', 11) && resettingLayer=="F") player.E.upgrades.push("11","12","13","14","15","16")
        if (hasMilestone ('F', 14) && resettingLayer=="F") player.E.upgrades.push("21","22","23","24","25","26","31","32","33","34","35","36","41","42","43","44","45")
    },
    passiveGeneration() {
