addLayer("A", {
    ...
    requires(){ 
        ...
        if (player.A.points.gte(250)) nerf = (player.A.points.times(player.A.power).times(player.A.passive).times(player.A.boost).times(tmp.A.powerEff).times(tmp.A.passiveEff).times(tmp.A.boostEff).times(1e100)).pow(1.5)
