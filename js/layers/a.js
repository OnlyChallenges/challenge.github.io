addLayer("a", {
        ...
        32: {
                name(){return hasAchievement("a", 32)?"<h3 style='color: red; font-size: 1em; text-shadow: blue 1px 1px 10px;>'Vaccinations are fake</h3>":"Vaccinations against the Infection"},
