addLayer("a", {
        ...
        32: {
                name(){return hasAchievement("a", 32)?"<h3 style='color: darkred:red; font-size: 1em; text-shadow: cyan:blue 1px 1px 10px;</h3>'Vaccinations are fake":"Vaccinations against the Infection"},
