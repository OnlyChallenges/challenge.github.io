addLayer("L", {
    ...
    colorcheckerTwo(){
    if ((player.L.randomizer == (7) || player.L.randomizer == (6) || player.L.randomizer == (2)) && (player.L.health <= player.L.healthMax)) player.L.spec = "#11f47f"
    if (player.points > 2.49) player.L.spec = "#11f4f7"
...
return func
            ...
            "Stats & Bonus": {
                content: [
                    ...
                    ["display-text", function(){return "You have hugged plasma a total of <rainbow> "+ formatWhole(player.L.hugs) + "</rainbow> times!"},{}],
                    "blank",
                    "blank",
                    "blank",
