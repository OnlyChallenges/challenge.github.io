...
if (player.L.randomizer == (7) && player.L.zone == (6)) func = "* You inflicted " + formatWhole((player.L.attack.add(player.L.Wattack.times(player.L.dmgMult).times(player.L.DMGBoost).floor()).minus(player.L.enemyDefense).max(0))) + " Damage on <water>Stone, Tidal, Daizy</water><br>* You lost " +formatWhole(player.L.enemyAttack.minus(player.L.defense.add(player.L.Wdefense.times(player.L.defenseRNG))).max(0))+" Health"
if (player.L.randomizer == (6) && player.L.zone == (6)) func = "* You inflicted " + formatWhole((player.L.attack.add(player.L.Wattack.times(player.L.dmgMult).times(player.L.DMGBoost).floor()).minus(player.L.enemyDefense).max(0))) + " Damage on <ruins>Plasma, Brian, JJ</ruins><br>* You lost " +formatWhole(player.L.enemyAttack.minus(player.L.defense.add(player.L.Wdefense.times(player.L.defenseRNG))).max(0))+" Health"
if (player.L.randomizer == (2) && player.L.zone == (6)) func = "* You inflicted " + formatWhole((player.L.attack.add(player.L.Wattack.times(player.L.dmgMult).times(player.L.DMGBoost).floor()).minus(player.L.enemyDefense).max(0))) + " Damage on <ruins>Vali</rainbow><br>* You lost " +formatWhole(player.L.enemyAttack.minus(player.L.defense.add(player.L.Wdefense.times(player.L.defenseRNG))).max(0))+" Health"
