    ...
    tabFormat: {
        "Spawn": {
            content: [
                ...
                ["display-text",
                    function () { 
                        if (player.timePlayed < modInfo.demoTime) return "DEMO MODE: <text style='color:lime'>" + formatBaseTime(player.timePlayed) + "</text> / <text style='color:green'>"+ formatBaseTime(modInfo.demoTime) +"</text>"
