addLayer("u", {
    ...
    challenges: {
        ...
        14: {
            name: "Virus Spread",
            challengeDescription(){return "The Population is dropping! Can you finish the challenge before it drops to 1?<br> Population Boosts Point Gain<br> (Population Boost: " + format(player.u.population.max(1))+"x)" },
        ...
        15: {
            ...
            challengeDescription(){return "The Population is exploding! Don't let it inflate as it decreases your point gain overtime!<br> Population nerfs Point Gain<br> (Population Nerf: /" + format(player.u.population.pow(0.5).max(1))+")" },
        ...
        16: {
            ...
            challengeDescription(){return "Infects grows more and more... towards a point where it's impossible to beat the challenge <br>(Population Boost: " + format(player.u.population.max(1))+"x)<br> (Infected Nerf: /" + format(player.u.infected) + ")" },
            canComplete: function() {return hasChallenge('d', 19)},
