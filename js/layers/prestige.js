...
doReset(resettingLayer) {
        ...
        // A KEEPING
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.p.upgrades.push('11', '12', '13')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.bP.upgrades.push('11', '12', '13')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.bP.milestones.push('11')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.cP.upgrades.push('11', '12', '13')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.cP.milestones.push('11', '12')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.dP.upgrades.push('11', '12', '13')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.dP.milestones.push('11', '12', '13')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.eP.upgrades.push('11', '12', '13', '14')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.eP.milestones.push('11', '12', '13')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.fP.upgrades.push('11', '12', '13', '14')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.fP.milestones.push('11', '12', '13', '14')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.gP.upgrades.push('11', '12', '13', '14', '15')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.gP.milestones.push('11', '12', '13', '14')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.hP.upgrades.push('11', '12', '13', '14', '15', '16')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.hP.milestones.push('11', '12', '13', '14')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.iP.upgrades.push('11', '12', '13', '14', '15', '16')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.iP.milestones.push('11', '12', '13', '14', '15')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.jP.upgrades.push('11', '12', '13', '14', '15', '16', '21')
        if (hasUpgrade('A', 11) && resettingLayer == "A, kP") player.jP.milestones.push('11', '12', '13', '14', '15')
        if (hasMilestone('kP', 12)) player.Ab.challenges.push['11']
if (hasMilestone('kP', 12)) player.Ab.challenges.push['12']
if (hasMilestone('kP', 12)) player.Ab.challenges.push['21']
